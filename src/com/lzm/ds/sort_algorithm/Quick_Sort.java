 ...
 *       快排和归并一样，也是用了"分治的思想"，只不过快排先解决大问题，再去解决小问题。归并则是先递归进入小问题，先解决小问题，在解决大问题.
 */
public class Quick_Sort {
    public static void main(String[] args) {
        // int[] arr = {921, 387, 563, 42, 837, 126, 708, 953, 246, 650, 811, 371, 84,
        // 432, 904, 699, 202, 753, 567, 185, 325, 968, 156, 576, 311, 647, 727, 128,
        // 841, 598, 478, 937, 30, 775, 811, 28, 869, 145, 464, 332, 598, 695, 104, 879,
        // 9, 616, 807, 187, 401, 723, 517};
        int[] arr = { 2, 2, 2, 2, 1 };
